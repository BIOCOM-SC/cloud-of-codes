...
if Country == "Comunitat_Valenciana_Murcia"
    principi = 6;
else
    principi = 5;
end
...
fit = fminsearch(squared_errors,[aa ab ac ad ae af ag ah],options); % BetaBQ, BetaBA2, BetaBA4, Beta_Altres; Ratio_ini_BQ, Ratio_ini_BA2, Ratio_ini_BA4, Ratio_ini_Altres
                ...
                if (fit(5) > 0.00001 && fit(1)>fit(2) && fit(1)>fit(3) && fit(1)>fit(4) && fit(2)>0 && fit(3)>0 && fit(4)>0)
                    n=n+1;
...
% % close
                ...
                elseif ((fit(5) > 0.00001 && (fit(1)<fit(2) || fit(2)<0) && (fit(1)<fit(3) || fit(3)<0) && (fit(1)<fit(4) || fit(4)<0)) || (fit(5) > 0.00001 && fit(2)<0 && fit(3)<0 && fit(4)<0))
                global_fit_data = [Fit_Asc1;Fit_Asc2;Fit_Asc4;Fit_Ctt]'; 
...
print(textCaption,'-dpng','-r300')
                ...
                elseif ((fit(5) > 0.00001 && fit(1)>fit(2) && (fit(1)<fit(3) || fit(3)<0) && (fit(1)<fit(4) || fit(4)<0) && fit(2)>0) || (fit(3)<0 && fit(4)<0 && fit(5) > 0.00001)) % ||(Country == "Luxembourg")
                global_fit_data = [Fit_Asc1;Fit_Asc2;Fit_Asc4;Fit_Ctt]'; 
...
print(textCaption,'-dpng','-r300')
                ...
                elseif ((fit(5) > 0.00001 && (fit(1)<fit(2) || fit(2)<0) && fit(1)>fit(3) && (fit(1)<fit(4) || fit(4)<0) && fit(3)>0) || (fit(2)<0 && fit(4)<0 && fit(5) > 0.00001))                              
                global_fit_data = [Fit_Asc1;Fit_Asc2;Fit_Asc4;Fit_Ctt]'; 
...
print(textCaption,'-dpng','-r300')               
                ...
                elseif ((fit(5) > 0.00001 && (fit(1)<fit(2) || fit(2)<0) && (fit(1)<fit(3) || fit(3)<0) && fit(1)>fit(4) && fit(4)>0) || (fit(2)<0 && fit(3)<0 && fit(5) > 0.00001))               
                global_fit_data = [Fit_Asc1;Fit_Asc2;Fit_Asc4;Fit_Ctt]'; 
...
print(textCaption,'-dpng','-r300')
                ...
                elseif ((fit(5) > 0.00001 && fit(1)>fit(2) && fit(1)>fit(3) && (fit(1)<fit(4) || fit(4)<0) && fit(2)>0 && fit(3)>0)||(fit(5) > 0.00001 && fit(4)<0))
                global_fit_data = [Fit_Asc1;Fit_Asc2;Fit_Asc4;Fit_Ctt]'; 
...
print(textCaption,'-dpng','-r300')
                ...
                elseif ((fit(5) > 0.00001 && (fit(1)<fit(2) || fit(2)<0) && fit(1)>fit(3) && fit(1)>fit(4) && fit(3)>0 && fit(4)>0)||(fit(5) > 0.00001 && fit(2)<0))
global_fit_data = [Fit_Asc1;Fit_Asc2;Fit_Asc4;Fit_Ctt]'; 
...
print(textCaption,'-dpng','-r300')
                ...
                elseif ((fit(5) > 0.00001 && fit(1)>fit(2) && (fit(1)<fit(3) || fit(3)<0) && fit(1)>fit(4) && fit(2)>0 && fit(4)>0)||(fit(5) > 0.00001 && fit(3)<0))
global_fit_data = [Fit_Asc1;Fit_Asc2;Fit_Asc4;Fit_Ctt]'; 
