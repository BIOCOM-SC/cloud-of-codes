function     [BDelta,BerrDelta,R0Delta,R0errDelta,DayDelta,DayDelta20,DayDelta40,DayDelta60,DayDelta80] = FAlphaDeltab(N_Desc, N_Asc1, N_Asc2, N_Asc4, N_Ctt,Country,WeekThurs)
...
if (Country == "Estonia" || Country == "Bulgaria" || Country == "Finland" || Country == "Greece" || Country == "Slovakia" || Country == "Cyprus" || Country == "Czechia")
        ...
        elseif  Country == "Cyprus" 
            ...
            aa=0.8; ad=0.05; ae=0.01; ah=0.01;
                ...
                % fos substitució!
                        ...
                        if (fit(3) > 0.002 && fit(1)>fit(2)) % ha de posar fit(3) > 0.006  !!!
                        n=n+1;
                ...
                t_plot=(1-2/7):1/7:(length(t)+2/7);
                        ...
                        PlotSeqVar_alfa_delta = table(Day_plot', Norm_Desc, Desc_int, Norm_Asc1, Asc1_int, Norm_Ctt, Ctt_int);
                        PlotSeqVar_alfa_delta.Properties.VariableNames = ['Dia',"Perc_alfa",'Error_alfa',"Perc_delta",'Error_delta',"Perc_altres","Error_altres"];
                    ...
                    yline(5,'--'); 
                        ...
                        Fit_alfa_delta = table(Fitting_date_plot', Fitplot_Desc',Fitplot_DescMAX',Fitplot_DescMIN', Fitplot_Asc1',Fitplot_Asc1MAX',Fitplot_Asc1MIN',...
                            Fitplot_Ctt',Fitplot_CttMAX',Fitplot_CttMIN');
                        Fit_alfa_delta.Properties.VariableNames = ['Dia',"Perc_alfa_dia","Perc_alfa_dia_errMAX","Perc_alfa_dia_errMIN","Perc_delta_dia","Perc_delta_dia_errMAX","Perc_delta_dia_errMIN",...
                            "Perc_altres_dia","Perc_altres_dia_errMAX","Perc_altres_dia_errMIN"];
...
% Els paràmetres Beta i R0 necessiten un valor inicial que després s'anirà
% ajustant automàticament:
aa=0.8; ab=0.05; ac=0.4; ad=0.15; ae=0.01; af=0.01; ag=0.01; ah=0.05;
...
close
                ...
                elseif ((fit(5) > 0.006 && fit(1)>fit(2) && (fit(1)<fit(3)|| fit(3)<0) && (fit(1)<fit(4)|| fit(4)<0) && fit(2)>0) || (fit(3)<0 && fit(4)<0 && fit(5) > 0.006))
                global_fit_data = [Fit_Asc1;Fit_Asc2;Fit_Asc4;Fit_Ctt]'; 
